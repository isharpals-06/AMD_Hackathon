...
ADAPTER_DIR = os.path.join(
    BASE_DIR, "Multi_Model_Router_Llama3_QLoRA_Finetuning.ipynb", "final_model"
)
OUTPUT_DIR = os.path.join(
    BASE_DIR, "Multi_Model_Router_Llama3_QLoRA_Finetuning.ipynb", "merged_model"
)
...
def main():
    ...
    try:
        ...
        print(
            "Please make sure you have hf transformers installed and access to meta-llama/Llama-3.2-1B on HuggingFace."
        )
        sys.exit(1)
