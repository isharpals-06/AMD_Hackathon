...
def cache_models():
    ...
    if not hf_token:
        ...
        print("Note: Gated models (like Gemma and Llama) require a HuggingFace access token to download.")
        print("Please run 'huggingface-cli login' or set HF_TOKEN before running this script if you get access errors.\n")
