...
def app_with_mocks():
    ...
    hf_response = {
        "text": "Mocked HuggingFace response",
        "input_tokens": 15,
        "output_tokens": 25,
        "total_tokens": 40,
    }
    ...
    with (
        ...
        patch(
            "app.services.huggingface_client.HuggingFaceClient.chat_completion",
            new_callable=AsyncMock,
            return_value=hf_response,
        ),
        patch(
            "app.services.huggingface_client.HuggingFaceClient.check_health",
            new_callable=AsyncMock,
            return_value=True,
        ),
    ):
